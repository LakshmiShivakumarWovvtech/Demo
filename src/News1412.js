...
export default class News1412 extends Component {
  constructor() {
    super();
    this.state = {
      news: '',
  ...
  search() {
    ...
    for (let i = 0; i < data.length; i++) {
      if (
        ...
        if (
          data[i].author.includes(this.state.news.toLowerCase()) ||
          data[i].title.includes(this.state.news) ||
            ...
            <View>
              <View
                ...
                <View style={{flexDirection: 'row'}}>
                  <Text style={{fontWeight: 'bold', fontSize: 12, padding: 10}}>
                    created_at:-
                  </Text>
